            ...
            groups.setdefault(key, []).append(
                {
                    ...
                    "manual_freight_code": clean_text(item[15]),
                    "required_delivery_date": clean_text(item[16]),
                    "manual_pallets": item[17],
                }
            )
        ...
        for row in shipments:
            ...
            conn.execute(
                ...
                INSERT INTO shipments (
                    ...
                    status, unload_date, unload_time, unload_booking_ref, required_delivery_date, delivered_at, source_file, imported_at, payload_json
                )
                VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
