        ...
        for shipment in shipment_set:
            ...
            conn.execute(
                ...
                INSERT INTO shipments (
                    ...
                    delivered_at, delivery_xml_path, source_file, imported_at, payload_json
                )
...
def mark_departed(shipment: str, departed_at: str | None = None, db_path: Path = DB_PATH) -> None:
    ...
    with sqlite3.connect(db_path) as conn:
        conn.execute(
            "UPDATE shipments SET status = ?, departed_at = ?, delivered_at = NULL, delivery_xml_path = NULL WHERE shipment = ?",
