...
function projectItalyPoint(lon, lat) {
  return {
    x: 80 + ((lon - 6.45) / (18.75 - 6.45)) * 740,
    y: 56 + ((47.10 - lat) / (47.10 - 36.65)) * 790,
  };
}
    ...
    <section class="geo-control-card">
      ...
      <div class="geo-body">
        <div class="italy-map-wrap">
          <svg class="italy-map" viewBox="0 0 900 900" role="img" aria-label="Mappa spedizioni per provincia">
            <defs>
            ...
            <rect class="italy-map-bg" x="0" y="0" width="900" height="900" rx="20" />
            <g class="italy-reference-map">
              <path class="italy-land" d="M146 186 L178 159 L221 151 L251 115 L291 98 L321 62 L373 68 L413 47 L468 69 L512 64 L552 91 L613 93 L654 128 L704 138 L735 178 L710 224 L668 236 L637 274 L581 276 L548 309 L492 297 L452 323 L405 299 L358 323 L304 309 L273 276 L219 279 L181 247 L134 241 L119 209 Z" />
              <path class="italy-land" d="M409 302 C452 325 465 360 450 398 C438 430 462 462 495 478 C535 499 569 517 589 555 C608 590 645 602 684 623 C725 646 764 684 780 735 C795 784 779 823 741 839 C701 856 678 824 692 787 C702 760 686 737 649 715 C601 686 564 662 533 620 C505 581 461 566 424 538 C388 511 372 466 388 424 C401 391 386 360 359 334 C346 321 368 282 409 302 Z" />
              <path class="italy-land" d="M162 529 C202 491 258 499 281 554 C307 617 283 723 223 760 C166 795 121 746 121 674 C120 612 125 564 162 529 Z" />
              <path class="italy-land" d="M487 788 C539 760 631 767 703 796 C770 823 804 861 784 881 C725 879 664 866 604 855 C553 846 496 839 462 821 C450 814 459 802 487 788 Z" />
              <path class="italy-region-line" d="M219 279 C257 241 297 238 337 270 C372 297 409 296 452 323" />
              <path class="italy-region-line" d="M273 276 C300 320 339 342 388 335" />
              <path class="italy-region-line" d="M358 323 C367 366 386 391 420 414" />
              <path class="italy-region-line" d="M420 414 C462 423 492 443 512 480" />
              <path class="italy-region-line" d="M495 478 C477 514 486 545 533 620" />
              <path class="italy-region-line" d="M589 555 C628 570 653 597 684 623" />
              <path class="italy-region-line" d="M649 715 C686 737 709 766 692 787" />
              <path class="italy-region-line" d="M581 276 C571 331 592 383 632 422" />
              <path class="italy-region-line" d="M162 529 C205 558 232 612 225 682" />
              <path class="italy-region-line" d="M503 804 C568 813 644 820 731 850" />
              <path class="italy-region-line" d="M321 62 C341 111 383 141 431 152" />
              <path class="italy-region-line" d="M431 152 C471 197 512 226 548 309" />
              <path class="italy-region-line" d="M178 159 C228 181 278 181 331 160" />
            </g>
            ${mapped.map(item => {
              const radius = 4 + (item.count / maxCount) * 5;
              const haloRadius = 12 + (item.pallets / Math.max(1, maxPallets)) * 22;
              const labelOffset = GEO_LABEL_OFFSETS[item.province];
              const labelDx = labelOffset?.[0] ?? (item.point.x > 700 ? -42 : 18);
              const labelDy = labelOffset?.[1] ?? 7;
              const labelAnchor = labelOffset?.[2] ?? (item.point.x > 700 ? "end" : "start");
              return `
