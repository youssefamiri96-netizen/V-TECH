...
async function performAction(action, extra = {}) {
  ...
  await reloadAfterMutation(shipments, { keepSelection: ["carrier", "service_level", "manual_passive", "manual_pallets", "unload_date", "unload_booking", "active_urgent"].includes(action) });
