...
const ITALY_MAP_SIZE = { width: 450, height: 450 };
const ITALY_MAP_BOUNDS = { west: 6.35, east: 18.75, north: 47.20, south: 36.65 };
const ITALY_MAP_PADDING = { left: 70, right: 55, top: 70, bottom: 42 };
      ...
      <div class="geo-body">
        <div class="italy-map-wrap">
          <svg class="italy-map" viewBox="0 0 ${ITALY_MAP_SIZE.width} ${ITALY_MAP_SIZE.height}" role="img" aria-label="Mappa spedizioni per provincia">
            ...
            <image class="italy-map-image" href="/italy-map-base.jpg?v=italy-real-base-20260522" x="0" y="0" width="${ITALY_MAP_SIZE.width}" height="${ITALY_MAP_SIZE.height}" preserveAspectRatio="xMidYMid meet" />
            ${mapped.map(item => {
              const percent = totalShipments ? item.count / totalShipments * 100 : 0;
              const radius = 3.8 + Math.sqrt(item.count / maxCount) * 5.2;
