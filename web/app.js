...
function render() {
  ...
  if (els.searchInput) {
    ...
    els.searchInput.placeholder = isRegistry
      ...
      : "Shipment, cliente, provincia, indirizzo...";
  }
  if (els.searchLabel) {
...
async function performAction(action, extra = {}) {
  ...
  if (action === "planned" && !actionExtra.plannedAt && state.plannedDateManual && state.plannedDate) {
    actionExtra.plannedAt = state.plannedDate;
  }
